...
static u32 UniformTypeBits[E_UNIFORM_TYPE_COUNT] =
{
	...
	EUF_MODEL_MATRIX,
	EUF_MODEL_VIEW_MATRIX_3X3,
	EUF_MODEL_MATRIX_3X3,
...
static const c8* RenderPathShortName[E_RENDER_PATH_COUNT] =
{
	"FR",
	"DS",
};
...
MY_FORCEINLINE const c8* getRenderPathShortName(E_RENDER_PATH path)
{ return RenderPathShortName[path]; }
